...
import com.example.juiceable.ui.theme.JuiceableTheme
    ...
    Surface(
        ...
        when (currentStep) {
            ...
            4 -> {
                ...
                LemonTextAndImage(
                    textLabelResourceId = R.string.lemon_empty_glas,
